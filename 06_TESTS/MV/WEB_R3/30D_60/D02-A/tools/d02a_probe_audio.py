...
TARGETS = [
    {
        "account": "火乐烁",
        "aweme_id": "7674182052884173553",
        "work_url": "https://www.douyin.com/video/7674182052884173553",
        "observed_duration_s": 26.467,
    },
    {
        "account": "Aura",
        "aweme_id": "7673796884212895016",
        "work_url": "https://www.douyin.com/video/7673796884212895016",
        "observed_duration_s": 24.034,
    },
]
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="r3_d02a_audio_") as td:
        tmp = Path(td)
    ...
    final_ref = ARTIFACT_DIR / "HG02_reference_做她的大地别做她的天.mp3"
    ...
    payload = {
        "song_family": "做她的大地别做她的天",
        "target_observed_audio_family": "做她的大地别做她的天（r&b）（氛围片段） / 大眼仔",
        ...
        "selected_listening_source_account": "火乐烁",
