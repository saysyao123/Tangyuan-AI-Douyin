...
- post this package once only;
- do not repost the same video with `EMOTION_FIRST`;
- record exact actual publish timestamp after manual posting;
- enter R3-D2 metrics at 1h / 3h / 24h;
