# Template｜MV Zero-Context Start Prompt v1.1
...
- 正常单一路径：选歌 -> Douyin-first BGM版本发现 -> BGM片段 -> Audio Timeline Package -> Natural Beat -> Director -> First Frames -> Dynamic -> Dynamic QA -> Shot Normalization -> Editor Audio Gate -> Picture Edit -> Subtitle -> Final QA -> Close；
