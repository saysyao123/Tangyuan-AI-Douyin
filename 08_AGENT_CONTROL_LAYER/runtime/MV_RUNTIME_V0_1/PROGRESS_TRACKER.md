...
| S1 | PROJECT_AUDIO | REVIEW | User-provided 21.4s source validated; full lyric timeline built; 16.06s candidate clipped | S1_RUN02_USER_MEDIA_ANALYSIS.md | HUMAN_AUDIO_LOCK_PENDING | User listens and approves or requests local S1 revision |
